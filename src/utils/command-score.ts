...
//copy paste of https://github.com/pacocoursey/cmdk/blob/main/cmdk/src/command-score.ts
//but added types
//I need a custom filter function for cmdk Command.
//this is what cmdk Command use by default as filter: a fuzzy search with scoring
