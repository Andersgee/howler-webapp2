...
function showAddMember(
  myRole: "ADMIN" | "CREATOR" | "MEMBER",
  inviteSetting: "PUBLIC" | "MEMBERS_AND_ABOVE" | "ADMINS_AND_ABOVE" | "CREATOR_ONLY"
) {
  if (inviteSetting === "PUBLIC") return true;
  if (inviteSetting === "MEMBERS_AND_ABOVE") return true;
  if (inviteSetting === "ADMINS_AND_ABOVE" && (myRole === "ADMIN" || myRole === "CREATOR")) return true;
  if (inviteSetting === "CREATOR_ONLY" && myRole === "CREATOR") return true;
